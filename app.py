...
st.title(":Classical Building: Smart Bank Mnagement System")
    ...
    if st.button("Create Account"):
        ...
        if account_number == "" or customer_name == "":
            ...
            if account_type == "Savings":
                ...
                success, message = create_savings_account(
                ...
                success, message = create_current_account(
        ...
        if account:
            ...
            with col2:
                ...
                if details["Account Type"] == "Savings":
                    ...
                    st.write(
                        f"**Overdraft Limit :** ₹{details['Overdraft Limit']:.2f}"
                    )
